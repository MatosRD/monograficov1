...
<div class="filtro">
    <div class="filtro2">
        ...
        <label style="margin-top: 15px;" for="favoriteOnly11"  >Habilidades:</label>
                    ...
                    <option value="mas">+ 5 años</option>
                    </select>
...
<div class="progrm2">
    ...
    <?php
                include 'conexion.php';
                $mostrar = mysqli_query($conexion, "SELECT * FROM personal where estrellas > 1 and rol = 'Desarrollador' ORDER BY estrellas ASC LIMIT 10");
                ?>
            ...
            <?php
                    ...
                    if (!empty(['filtro'])) { // Corregido para comprobar la variable $_POST
